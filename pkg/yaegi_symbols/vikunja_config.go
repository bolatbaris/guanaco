...
func init() {
	Symbols["code.vikunja.io/api/pkg/config/config"] = map[string]reflect.Value{
		...
		"AuthSingleUserEmail":                        reflect.ValueOf(config.AuthSingleUserEmail),
		"AuthSingleUserEnabled":                      reflect.ValueOf(config.AuthSingleUserEnabled),
		"AuthSingleUserName":                         reflect.ValueOf(config.AuthSingleUserName),
		"AuthSingleUserPassword":                     reflect.ValueOf(config.AuthSingleUserPassword),
		"AuthSingleUserUsername":                     reflect.ValueOf(config.AuthSingleUserUsername),
		...
		"SentryEnvironment":                          reflect.ValueOf(config.SentryEnvironment),
		...
		"SentryFrontendReplayOnErrorSampleRate":      reflect.ValueOf(config.SentryFrontendReplayOnErrorSampleRate),
		"SentryFrontendReplaySessionSampleRate":      reflect.ValueOf(config.SentryFrontendReplaySessionSampleRate),
		"SentryFrontendTracesSampleRate":             reflect.ValueOf(config.SentryFrontendTracesSampleRate),
		"SentryTracesSampleRate":                     reflect.ValueOf(config.SentryTracesSampleRate),
