...
func newInitCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "init",
		Short: "Configure the single-user Vikunja automation and write .veans.yml",
  ...
  4. Mint a scoped API token for the authenticated user
  5. Store the automation token in your keychain (or ~/.config/veans/credentials.yml)
  6. Write .veans.yml to the repository root

The token is used only by veans for this repository and can be rotated or
revoked at any time.`,
